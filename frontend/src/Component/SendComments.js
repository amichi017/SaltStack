...
class SendComments extends React.Component {
    constructor(props) {
        super(props);
...
render(){
  ...
  return (
    <Paper component="form" className={this.props.classes.root}>
      ...
      <IconButton color="primary" className={this.props.classes.iconButton} aria-label="directions">
        <DirectionsIcon />
      </IconButton>
    </Paper>
  );
...
export default withStyles(styles)(SendComments);